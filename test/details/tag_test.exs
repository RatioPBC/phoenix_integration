defmodule PhoenixIntegration.Details.TagTest do
  ...
  describe "select" do
    ...
    test "no selection means the first value is selected" do
      ...
      |> Floki.parse_fragment!()
      |> Tag.new!()
      |> MapA.assert_fields(values: ["One"], has_list_value: false)
    end
    ...
    test "A *multiple* select does NOT default-select the first value" do
      ...
      |> Floki.parse_fragment!()
      |> Tag.new!()
      |> MapA.assert_fields(values: [], has_list_value: true)
    end
  end
